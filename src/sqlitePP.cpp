...
sqlitePlusPlus::~sqlitePlusPlus() { sqlite3_close(db_); }

void sqlitePlusPlus::exec(const std::string &sql) {
  char *errmsg;
...
sqlitePlusPlus::statement_ptr sqlitePlusPlus::prepare(const std::string &sql) {
  sqlite3_stmt *stmt;
